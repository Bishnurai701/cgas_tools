...
import com.oagreport.repository.VoucherSubTypeRepository;
...
public class VoucherSubTypeService {
    ...
    public DataTablesOutput<VoucherSubType>FindAll(DataTablesInput input){
        DataTablesOutput<VoucherSubType> data = voucherSubTypeRepository.findAll(input);
        return  data;
    }

    public Iterable<VoucherSubType> FindAll(){
        Iterable<VoucherSubType> data = voucherSubTypeRepository.findAll();
        return  data;
    }
