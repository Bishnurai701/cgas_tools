...
@NamedQueries({ @NamedQuery(name = Ministry.FindByMinistryId, query = "select e from Ministry e where e.id=:id") })
public class Ministry extends BaseDto {
	...
	// @SequenceGenerator(sequenceName = "SQ_PERSON", allocationSize = 1, name =
	// "SQ_PERSON")
	@Column(name = "ID")
	private Long id;
