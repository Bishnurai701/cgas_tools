...
@Transactional
@RequestScope
public class MiscReportService {
    ...
    {
        StoredProcedureQuery query = entityManager.createStoredProcedureQuery("ACCOUNT_MISC_REPORT.MaLePa17")
        ...
        try {
            ...
            StoredProcedureQuery query1 = entityManager.createStoredProcedureQuery("ACCOUNT_MISC_REPORT.MaLePa17_Summary")
                    .registerStoredProcedureParameter(1, Long.class, ParameterMode.IN)
                    .registerStoredProcedureParameter(2, Long.class, ParameterMode.IN)
                    .registerStoredProcedureParameter(3, Long.class, ParameterMode.IN)
                    .registerStoredProcedureParameter(4, Long.class, ParameterMode.IN)
    ...
    {
        StoredProcedureQuery query = entityManager.createStoredProcedureQuery("ACCOUNT_MISC_REPORT.MaLePa22")
                .registerStoredProcedureParameter(1, Long.class, ParameterMode.IN)
                .registerStoredProcedureParameter(2, Long.class, ParameterMode.IN)
                .registerStoredProcedureParameter(3, Long.class, ParameterMode.IN)
                .registerStoredProcedureParameter(4, Long.class, ParameterMode.IN)
...
//            List<Object[]> summary = (List<Object[]>) query.getOutputParameterValue(11);
    ...
    {
        StoredProcedureQuery query = entityManager.createStoredProcedureQuery("ACCOUNT_MISC_REPORT.MaLePa208")
                .registerStoredProcedureParameter(1, Long.class, ParameterMode.IN)
                .registerStoredProcedureParameter(2, Long.class, ParameterMode.IN)
                .registerStoredProcedureParameter(3, Long.class, ParameterMode.IN)
                .registerStoredProcedureParameter(4, Long.class, ParameterMode.IN)
        ...
        try {
            ...
            StoredProcedureQuery query1 = entityManager.createStoredProcedureQuery("ACCOUNT_MISC_REPORT.MaLePa208_SUMMARY")
                    .registerStoredProcedureParameter(1, Long.class, ParameterMode.IN)
                    .registerStoredProcedureParameter(2, Long.class, ParameterMode.IN)
                    .registerStoredProcedureParameter(3, Long.class, ParameterMode.IN)
                    .registerStoredProcedureParameter(4, Long.class, ParameterMode.IN)
    ...
    {
        StoredProcedureQuery query = entityManager.createStoredProcedureQuery("ACCOUNT_MISC_REPORT.MaLePa209")
                .registerStoredProcedureParameter(1, Long.class, ParameterMode.IN)
                .registerStoredProcedureParameter(2, Long.class, ParameterMode.IN)
                .registerStoredProcedureParameter(3, Long.class, ParameterMode.IN)
                .registerStoredProcedureParameter(4, Long.class, ParameterMode.IN)
        ...
        try {
            ...
            StoredProcedureQuery query1 = entityManager.createStoredProcedureQuery("ACCOUNT_MISC_REPORT.MaLePa209_SUMMARY")
                    .registerStoredProcedureParameter(1, Long.class, ParameterMode.IN)
                    .registerStoredProcedureParameter(2, Long.class, ParameterMode.IN)
                    .registerStoredProcedureParameter(3, Long.class, ParameterMode.IN)
                    .registerStoredProcedureParameter(4, Long.class, ParameterMode.IN)
    ...
    {
        StoredProcedureQuery query = entityManager.createStoredProcedureQuery("ACCOUNT_MISC_REPORT.MaLePa210")
                .registerStoredProcedureParameter(1, Long.class, ParameterMode.IN)
                .registerStoredProcedureParameter(2, Long.class, ParameterMode.IN)
                .registerStoredProcedureParameter(3, Long.class, ParameterMode.IN)
                .registerStoredProcedureParameter(4, Long.class, ParameterMode.IN)
    ...
    {
        StoredProcedureQuery query = entityManager.createStoredProcedureQuery("ACCOUNT_MISC_REPORT.MaLePa211")
                .registerStoredProcedureParameter(1, Long.class, ParameterMode.IN)
                .registerStoredProcedureParameter(2, Long.class, ParameterMode.IN)
                .registerStoredProcedureParameter(3, Long.class, ParameterMode.IN)
                .registerStoredProcedureParameter(4, Long.class, ParameterMode.IN)
    ...
    {
        StoredProcedureQuery query = entityManager.createStoredProcedureQuery("ACCOUNT_MISC_REPORT.MaLePa213")
                .registerStoredProcedureParameter(1, Long.class, ParameterMode.IN)
                .registerStoredProcedureParameter(2, Long.class, ParameterMode.IN)
                .registerStoredProcedureParameter(3, Long.class, ParameterMode.IN)
                .registerStoredProcedureParameter(4, Long.class, ParameterMode.IN)
        ...
        try {
            ...
            StoredProcedureQuery query1 = entityManager.createStoredProcedureQuery("ACCOUNT_MISC_REPORT.MaLePa213_SUMMARY")
                    .registerStoredProcedureParameter(1, Long.class, ParameterMode.IN)
                    .registerStoredProcedureParameter(2, Long.class, ParameterMode.IN)
                    .registerStoredProcedureParameter(3, Long.class, ParameterMode.IN)
                    .registerStoredProcedureParameter(4, Long.class, ParameterMode.IN)
    ...
    {
        StoredProcedureQuery query = entityManager.createStoredProcedureQuery("ACCOUNT_MISC_REPORT.MaLePa214")
                .registerStoredProcedureParameter(1, Long.class, ParameterMode.IN)
                .registerStoredProcedureParameter(2, Long.class, ParameterMode.IN)
                .registerStoredProcedureParameter(3, Long.class, ParameterMode.IN)
                .registerStoredProcedureParameter(4, Long.class, ParameterMode.IN)
